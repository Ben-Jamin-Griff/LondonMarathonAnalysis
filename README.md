...
The project was created to explore 10 years of london marathon data scraped from the offical london marathon results pages. The web scrapper was written on an iPad using Pythonista and the source control was managed with Working Copy, this was done as an attempt to test out remote development technoloiges. The analysis of the data was conducted using Jupyter Notebooks and is still ongoing... <br>
